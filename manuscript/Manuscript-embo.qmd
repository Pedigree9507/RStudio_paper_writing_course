...
mainfont: Arial
monofont: Arial #Times New Roman
fontsize: 11pt
linestretch: 1.2
linkcolor: blue
...
csl: the-embo-journal.csl #change according to journal
---
...
terminal command to create pdf : \$ cd "directory" \$ quarto render Manuscript.qmd --to pdf

**text in bold** *italic* [underline]{.underline} \^superscript
...
You can add your figures into the rendered document. We saved the figures into /manuscript/figures or /manuscript/figure_supplements and can insert [@Acebron2016] them from there. We use knitr::include_graphics for this. The title and legend can also be edited, as will as the width of the output figure. Test comment behaviour: <!--# Test comment for git show -->
